import SvgLogoNV from './logo_NP.svg';
...
const SvGBtnPlus = () => {
	return (
		<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			></path>
			<path d="M7.99988 10.6668V5.3335" stroke="black" strokeOpacity="" strokeWidth="1.2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
			<path d="M10.6666 8.00024H5.33325" stroke="black" strokeOpacity="" strokeWidth="1.2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
		</svg>
	);
};

export { SvGBtnPlus, SvgLogoNV , SvgDeleteBtn,crmLogo,rozetkaLogo,promLogo,videoregistrator,kalyan};
